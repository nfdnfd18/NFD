...
function SplashCursor({ 
  ...
  useEffect(() => {
    ...
    if (!gl) return; // Ensure WebGL context is valid
    ...
    function getWebGLContext(canvas) {
      ...
      if (!gl) {
        ...
        return { gl: null, ext: {} }; // Return a safe fallback
      }
    ...
    function initFramebuffers() {
      ...
      if (rgba !== null) { // Add a check to ensure rgba is not null
        dye = createDoubleFBO(
          dyeRes.width,
          dyeRes.height,
          rgba.internalFormat,
        ...
        // Handle the case where rgba is null, e.g., log an error or set default values
        console.error("rgba is null, cannot create DoubleFBO");
        // Optionally, initialize dye with default values or handle the error
      }
